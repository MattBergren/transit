// generated on 2016-09-21 using generator-mspfed 0.0.2
...
// Resources file
gulp.task('resources', () => {
    return gulp.src('app/resources/*.*').pipe(gulp.dest('dist/resources'));
});

gulp.task('clean', del.bind(null, ['.tmp', 'dist']));

gulp.task('serve', ['assemble', 'styles', 'scripts', 'fonts', 'resources'], () => {
    browserSync({
        notify: false,
        port: 9000,
        server: {
...
gulp.task('build', ['lint', 'html', 'images', 'fonts', 'extras', 'resources'], () => {
    cache.caches = {};
